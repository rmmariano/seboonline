...
'Item categories(created_by)': 'Item categories(created_by)',
'Item categories(updated_by)': 'Item categories(updated_by)',
'Items': 'Itens',
'Items(created_by)': 'Items(created_by)',
'Items(updated_by)': 'Items(updated_by)',
'JSON': 'JSON',
...
'Registration successful': 'Inscrição bem sucedida',
...
'Videos': 'Vídeos',
'View': 'Visualizar',
'View %(entity)s': 'Visualizar %(entity)s',
'Web2py': 'Web2py',
'Welcome': 'Bem-vindo',
'Welcome %s': 'Bem-vindo %s',
'Welcome to info!': 'Welcome to info!',
